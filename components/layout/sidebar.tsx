        ...
        <div className="flex flex-col h-full">
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              <div className="rounded-lg bg-black dark:bg-white p-2 flex-shrink-0">
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              <Button
                ...
                onClick={toggleTheme}
                className={cn(
                  "font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-300",
                  isCollapsed 
              ...
              >
                {theme === 'dark' ? 
                  <Sun className="h-4 w-4 flex-shrink-0 text-gray-700 dark:text-slate-300" /> : 
                  <Moon className="h-4 w-4 flex-shrink-0 text-gray-700 dark:text-slate-300" />
                }
                <span className={cn(
                  "transition-all duration-300",
                  isCollapsed && "lg:hidden"
