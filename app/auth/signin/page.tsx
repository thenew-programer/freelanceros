		...
		>
			<div className="space-y-6">
				...
				<div className="space-y-3">
					{/* GitHub and Google Login in a row */}
					<div className="grid grid-cols-2 gap-3">
						<Button
							type="button"
							onClick={handleGithubLogin}
							disabled={isGithubLoading || isLoading || isJuryLoading || isGoogleLoading}
							variant="outline"
							className="border-gray-300 hover:bg-gray-50 flex items-center justify-center"
						>
							{isGithubLoading ? (
						...
						<Button
							...
							disabled={isGoogleLoading || isLoading || isJuryLoading || isGithubLoading}
							variant="outline"
							className="border-gray-300 hover:bg-gray-50 flex items-center justify-center"
						>
							{isGoogleLoading ? (
					...
					<Button
						...
						disabled={isJuryLoading || isLoading || isGoogleLoading || isGithubLoading}
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
					...
					<Button
						...
						disabled={isLoading || isJuryLoading || isGoogleLoading || isGithubLoading}
					>
						{isLoading ? (
							<>
